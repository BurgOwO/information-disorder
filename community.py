...
if __name__ == "__main__":
    ...
    output_file = "community.csv"

    top_communities = ["realKarliBonne", "Qrashthematrix", "BannonWarRoom", "epochtimes", "Jack_Posobiec", "nationalpulse", "veryreasonable", "followsthewhiterabbit", "pjwnews", "lifesitetelegram"]
