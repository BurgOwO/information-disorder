...
\begin{boxH}
	...
	\end{itemize}
\end{boxH}
Nell’ambito dell’analisi dei grafi, uno degli aspetti centrali riguarda il calcolo del tasso di apertura dei nodi, che consente di valutare la relazione tra le caratteristiche topologiche del grafo e le proprietà dei nodi stessi.\\
In particolare, è stato condotto uno studio approfondito volto a determinare la \textit{correlazione tra il tasso di apertura e due diverse metodologie di chiusura: quella matematica e quella basata sui grafi.} \\
