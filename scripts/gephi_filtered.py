...
target_set = {"ArrestsIndictmentsJustice", "candlesinthenight", "WeTheMedia", "CharlieKirk", "Not_On_The_Beeb", "CheLineTv", "thepeoplesaudit", "PearFEED"}

dizionario = {}

for index, replies in enumerate(df["replies"]):
    # Verifica se il canale di destinazione appartiene al set
    if df["channelusername"][index] in target_set:
...
# Nome dei file CSV
nodes = "csv/nodes_filtered.csv"
archs = "csv/archs_filtered.csv"
